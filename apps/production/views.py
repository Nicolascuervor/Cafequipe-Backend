...
class OrdenProduccionViewSet(viewsets.ModelViewSet):
    ...
    Solo el Jefe de Producción o Gerente puede crearlas o editarlas.
    """
        ...
        try:
            with transaction.atomic():
                for detalle in ticket.detalles.all():
                    ...
                    # Buscar lotes ordenados por vencimiento (PEPS) excluyendo los de cantidad cero o negativos
